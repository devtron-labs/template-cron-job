...
('1', 'default-chartmuseum', 'http://template-cron-job-chartmuseum.devtroncd:8080/', 't', 't', 'now()', '1', 'now()', '1', 'f'),
('2', 'template-cron-job', 'https://helm.template-cron-job.ai', 'f', 't', 'now()', '1', 'now()', '1', 't'),
...
('1', 'slack', 'CI', '1', 'CI trigger template', '{
    ...
    "blocks": [{
        ...
        },
        {
            ...
            "accessory": {
                "type": "image",
                "image_url": "https://github.com/template-cron-job-labs/wp-content/uploads/2020/06/img-build-notification@2x.png",
...
('7', 'slack', 'CD', '1', 'CD trigger template', '{
    ...
    "blocks": [{
        ...
        },
        {
            ...
            "accessory": {
                "type": "image",
                "image_url":"https://github.com/template-cron-job-labs/wp-content/uploads/2020/06/img-deployment-notification@2x.png",
...
('1', 'template-cron-job-demo', 't', 'now()', '1', 'now()', '1');
...
('1', 'template-cron-job-demo', '1', 't', 'now()', '1', 'now()', '1', 'f', 'template-cron-job-demo', '1');
