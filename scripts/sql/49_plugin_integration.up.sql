...
('1', 'K6 Load testing','K6 is an open-source tool and cloud service that makes load testing easy for developers and QA engineers.','PRESET','https://raw.githubusercontent.com/template-cron-job-labs/template-cron-job/main/assets/k6-plugin-icon.png','f', 'now()', '1', 'now()', '1'),
('2', 'Sonarqube','Enhance Your Workflow with Continuous Code Quality & Code Security.','PRESET','https://raw.githubusercontent.com/template-cron-job-labs/template-cron-job/main/assets/sonarqube-plugin-icon.png','f', 'now()', '1', 'now()', '1');
