...
import (
	"encoding/json"
	"fmt"
	chartService "github.com/devtron-labs/template-cron-job/pkg/chart"
...
func (impl PropertiesConfigServiceImpl) UpdateEnvironmentProperties(appId int, propertiesRequest *EnvironmentProperties, userId int32) (*EnvironmentProperties, error) {
	...
	//FIXME add check for restricted NS also like (kube-system, template-cron-job, monitoring, etc)
