...
import (
	"bytes"
	openapi "github.com/devtron-labs/template-cron-job/api/helm-app/openapiClient"
	...
	repository2 "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/repository"
	appStoreDiscoverRepository "github.com/devtron-labs/template-cron-job/pkg/appStore/discover/repository"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/values/service"
	repository5 "github.com/devtron-labs/template-cron-job/pkg/cluster/repository"
	"github.com/devtron-labs/template-cron-job/pkg/sql"
	repository4 "github.com/devtron-labs/template-cron-job/pkg/team"
	...
	bean2 "github.com/devtron-labs/template-cron-job/api/bean"
	application2 "github.com/devtron-labs/template-cron-job/client/argocdServer/application"
	"github.com/devtron-labs/template-cron-job/client/argocdServer/repository"
	"github.com/devtron-labs/template-cron-job/client/pubsub"
	repository3 "github.com/devtron-labs/template-cron-job/internal/sql/repository"
	"github.com/devtron-labs/template-cron-job/internal/util"
	"github.com/devtron-labs/template-cron-job/pkg/bean"
	cluster2 "github.com/devtron-labs/template-cron-job/pkg/cluster"
	"github.com/go-pg/pg"
...
const (
	DEFAULT_ENVIRONMENT_OR_NAMESPACE_OR_PROJECT = "template-cron-job"
...
func (impl *InstalledAppServiceImpl) DeployDefaultChartOnCluster(bean *cluster2.ClusterBean, userId int32) (bool, error) {
	...
	// STEP 2 - create project with name "template-cron-job"
