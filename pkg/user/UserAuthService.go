...
import (
	...
	casbin2 "github.com/devtron-labs/template-cron-job/pkg/user/casbin"
	repository2 "github.com/devtron-labs/template-cron-job/pkg/user/repository"
	"github.com/go-pg/pg"
	"log"
	"math/rand"
	"net/http"
	...
	"github.com/devtron-labs/template-cron-job/pkg/auth"
...
func WhitelistChecker(url string) bool {
	urls := []string{
		...
		"/orchestrator/template-cron-job/auth/verify",
