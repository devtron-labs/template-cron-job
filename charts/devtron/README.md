...
```bash
$ git clone [https://github.com/template-cron-job-labs/template-cron-job-installation-script.git](https://github.com/devtron-labs/template-cron-job-installation-script.git)
$ cd template-cron-job-installation-script/charts
$ #modify values in values.yaml
$ helm install template-cron-job . -f values.yaml
```
...
```bash
$ git clone [https://github.com/template-cron-job-labs/template-cron-job-installation-script.git](https://github.com/devtron-labs/template-cron-job-installation-script.git)
$ cd template-cron-job-installation-script/charts/template
...
$ kubectl apply -n devtroncd -f charts/template/template-cron-job-installer.yaml
```
