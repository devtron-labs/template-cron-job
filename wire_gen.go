...
import (
	...
	cluster3 "github.com/devtron-labs/template-cron-job/api/cluster"
	...
	client3 "github.com/devtron-labs/template-cron-job/api/helm-app"
	module2 "github.com/devtron-labs/template-cron-job/api/module"
	"github.com/devtron-labs/template-cron-job/api/restHandler"
	app3 "github.com/devtron-labs/template-cron-job/api/restHandler/app"
	...
	"github.com/devtron-labs/template-cron-job/client/argocdServer/cluster"
	repository5 "github.com/devtron-labs/template-cron-job/client/argocdServer/repository"
	...
	client4 "github.com/devtron-labs/template-cron-job/client/jira"
	...
	"github.com/devtron-labs/template-cron-job/pkg/appStore/bean"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/common"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/fullMode"
	repository8 "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/repository"
	service2 "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/service"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/tool"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/tool/gitops"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/discover/repository"
	service3 "github.com/devtron-labs/template-cron-job/pkg/appStore/discover/service"
	...
	appWorkflow2 "github.com/devtron-labs/template-cron-job/pkg/appWorkflow"
	...
	repository6 "github.com/devtron-labs/template-cron-job/pkg/pipeline/repository"
	"github.com/devtron-labs/template-cron-job/pkg/plugin"
	repository7 "github.com/devtron-labs/template-cron-job/pkg/plugin/repository"
...
func InitializeApp() (*App, error) {
	...
	pubSubClientRestHandlerImpl := restHandler.NewPubSubClientRestHandlerImpl(sugaredLogger, cdConfig)
	...
	mainApp := NewApp(muxRouter, sugaredLogger, sseSSE, versionServiceImpl, enforcer, db, sessionManager, appServiceImpl)
	return mainApp, nil
}
...
var (
	...
	_wireRefChartProxyDirValue = appStoreBean.RefChartProxyDir("scripts/template-cron-job-reference-helm-charts")
)
