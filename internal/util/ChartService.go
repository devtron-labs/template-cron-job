...
import (
	...
	repository4 "github.com/devtron-labs/template-cron-job/client/argocdServer/repository"
...
func (impl *ChartTemplateServiceImpl) GetUserEmailIdAndNameForGitOpsCommit(userId int32) (string, string) {
	emailId := "template-cron-job-bot@template-cron-job.ai"
	name := "template-cron-job bot"
