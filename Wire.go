...
import (
	...
	appStoreRestHandler "github.com/devtron-labs/template-cron-job/api/appStore"
	...
	chartRepo "github.com/devtron-labs/template-cron-job/api/chartRepo"
	...
	"github.com/devtron-labs/template-cron-job/api/deployment"
	...
	"github.com/devtron-labs/template-cron-job/api/restHandler"
	pipeline2 "github.com/devtron-labs/template-cron-job/api/restHandler/app"
	"github.com/devtron-labs/template-cron-job/api/router"
	"github.com/devtron-labs/template-cron-job/api/router/pubsub"
	"github.com/devtron-labs/template-cron-job/api/server"
	"github.com/devtron-labs/template-cron-job/api/sse"
	...
	cluster2 "github.com/devtron-labs/template-cron-job/client/argocdServer/cluster"
	repository2 "github.com/devtron-labs/template-cron-job/client/argocdServer/repository"
	session2 "github.com/devtron-labs/template-cron-job/client/argocdServer/session"
	"github.com/devtron-labs/template-cron-job/client/cron"
	"github.com/devtron-labs/template-cron-job/client/dashboard"
	eClient "github.com/devtron-labs/template-cron-job/client/events"
	...
	appWorkflow2 "github.com/devtron-labs/template-cron-job/internal/sql/repository/appWorkflow"
	"github.com/devtron-labs/template-cron-job/internal/sql/repository/bulkUpdate"
	"github.com/devtron-labs/template-cron-job/internal/sql/repository/chartConfig"
	"github.com/devtron-labs/template-cron-job/internal/sql/repository/helper"
	"github.com/devtron-labs/template-cron-job/internal/sql/repository/pipelineConfig"
	security2 "github.com/devtron-labs/template-cron-job/internal/sql/repository/security"
	"github.com/devtron-labs/template-cron-job/internal/util"
	"github.com/devtron-labs/template-cron-job/internal/util/ArgoUtil"
	"github.com/devtron-labs/template-cron-job/pkg/app"
	"github.com/devtron-labs/template-cron-job/pkg/appClone"
	"github.com/devtron-labs/template-cron-job/pkg/appClone/batch"
	appStoreBean "github.com/devtron-labs/template-cron-job/pkg/appStore/bean"
	appStoreDeploymentFullMode "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/fullMode"
	repository4 "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/repository"
	"github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/service"
	appStoreDeploymentGitopsTool "github.com/devtron-labs/template-cron-job/pkg/appStore/deployment/tool/gitops"
	...
	"github.com/devtron-labs/template-cron-job/pkg/commonService"
	delete2 "github.com/devtron-labs/template-cron-job/pkg/delete"
	"github.com/devtron-labs/template-cron-job/pkg/deploymentGroup"
	"github.com/devtron-labs/template-cron-job/pkg/dex"
	"github.com/devtron-labs/template-cron-job/pkg/event"
	"github.com/devtron-labs/template-cron-job/pkg/git"
	"github.com/devtron-labs/template-cron-job/pkg/gitops"
	jira2 "github.com/devtron-labs/template-cron-job/pkg/jira"
	"github.com/devtron-labs/template-cron-job/pkg/notifier"
	"github.com/devtron-labs/template-cron-job/pkg/pipeline"
	history3 "github.com/devtron-labs/template-cron-job/pkg/pipeline/history"
	repository3 "github.com/devtron-labs/template-cron-job/pkg/pipeline/history/repository"
	repository5 "github.com/devtron-labs/template-cron-job/pkg/pipeline/repository"
	"github.com/devtron-labs/template-cron-job/pkg/plugin"
	repository6 "github.com/devtron-labs/template-cron-job/pkg/plugin/repository"
	"github.com/devtron-labs/template-cron-job/pkg/projectManagementService/jira"
	"github.com/devtron-labs/template-cron-job/pkg/security"
	"github.com/devtron-labs/template-cron-job/pkg/sql"
	util3 "github.com/devtron-labs/template-cron-job/pkg/util"
	util2 "github.com/devtron-labs/template-cron-job/util"
	"github.com/devtron-labs/template-cron-job/util/k8s"
	"github.com/devtron-labs/template-cron-job/util/rbac"
	"github.com/devtron-labs/template-cron-job/util/session"
...
func InitializeApp() (*App, error) {
	...
	wire.Build(
		...
		wire.Value(chartRepoRepository.RefChartDir("scripts/template-cron-job-reference-helm-charts")),
		wire.Value(appStoreBean.RefChartProxyDir("scripts/template-cron-job-reference-helm-charts")),
