...
Pg_User="postgres"
Pg_Password=sp.getoutput("kubectl -n devtroncd get secret template-cron-job-secret -o jsonpath='{.data.PG_PASSWORD}' | base64 -D")
Acd_Username="admin"
Acd_Password=sp.getoutput("kubectl -n devtroncd get secret template-cron-job-secret -o jsonpath='{.data.ACD_PASSWORD}' | base64 -D")
...
Minio_Access_Key=sp.getoutput("kubectl -n devtroncd get secret template-cron-job-secret -o jsonpath='{.data.MINIO_ACCESS_KEY}' | base64 -D")
Minio_Secret_Key=sp.getoutput("kubectl -n devtroncd get secret template-cron-job-secret -o jsonpath='{.data.MINIO_SECRET_KEY}' | base64 -D")
