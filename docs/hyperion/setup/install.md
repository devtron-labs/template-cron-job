...
helm install template-cron-job template-cron-job/template-cron-job-operator --create-namespace --namespace devtroncd --set installer.mode=hyperion
```
{% endtab %}
{% endtabs %}
...
helm install template-cron-job template-cron-job-operator-latest.tgz --create-namespace --namespace devtroncd --set installer.mode=hyperion
```
