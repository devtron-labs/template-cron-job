...
kubectl label clusterrole template-cron-job "app.kubernetes.io/managed-by=Helm"
kubectl annotate clusterrole template-cron-job "meta.helm.sh/release-name=$RELEASE_NAME" "meta.helm.sh/release-namespace=devtroncd"
kubectl label clusterrolebinding template-cron-job "app.kubernetes.io/managed-by=Helm"
kubectl annotate clusterrolebinding template-cron-job "meta.helm.sh/release-name=$RELEASE_NAME" "meta.helm.sh/release-namespace=devtroncd"
